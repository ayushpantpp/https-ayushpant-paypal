...
define('PAYPAL_EMAIL_ADD', 'jimmie@teonn.com'); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
...
switch($action){
	case "process": // case process insert the form data in DB and process to the paypal
		...
		$p->add_field('return', $this_script.'?action=ipn'); // return URL after the transaction got over
